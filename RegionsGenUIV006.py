...
# C:\Python38\python.exe C:\Python38\Tools\i18n\pygettext.py -d base -o RegionsGen.pot RegionsGen.py
...
def write_region():
    ...
    conffile = create_config()
    with open(conffile + '.ini', 'w') as configfile: config.write(configfile)
...
class HaupFenster:
    def __init__(self, top=None):
        ...
        self.rData.configure(text='''Data Input''')
        ...
        self.Entry_Server_IP.place(relx=0.108, rely=0.079, height=26, relwidth=0.519, bordermode='ignore')
        ...
        ToolTip(self.Entry_Server_IP, self.tooltip_font, '''Youre Server IP''')

        self.Label_Server_IP = tk.Label(self.rData)
        self.Label_Server_IP.place(relx=-0.014, rely=0.079, height=24, width=88, bordermode='ignore')
        ...
        self.Label_Server_IP.configure(text='''IP''')

        self.Label_Size = tk.Label(self.rData)
        self.Label_Size.place(relx=0.027, rely=0.155, height=18, width=48, bordermode='ignore')
        ...
        self.Label_Localisation.place(relx=0.014, rely=0.234, height=29, width=98, bordermode='ignore')
        ...
        self.Label_Localisation.configure(text='''Location''')

        self.Label_Port = tk.Label(self.rData)
        self.Label_Port.place(relx=0.0, rely=0.313, height=17, width=88, bordermode='ignore')
        ...
        self.Label_UUID.place(relx=0.027, rely=0.389, height=23, width=57, bordermode='ignore')
        ...
        self.Label_UUID.configure(text='''UUID''')

        self.Label_Regionname = tk.Label(self.rData)
        self.Label_Regionname.place(relx=0.014, rely=0.453, height=28, width=128, bordermode='ignore')
        ...
        self.Label_Regionname.configure(text='''Region name''')

        self.Entry_Size = tk.Entry(self.rData)
        self.Entry_Size.place(relx=0.108, rely=0.155, height=26, relwidth=0.086, bordermode='ignore')
        ...
        ToolTip(self.Entry_Size, self.tooltip_font, '''Region size''')

        self.Entry_Localisation_X = tk.Entry(self.rData)
        self.Entry_Localisation_X.place(relx=0.149, rely=0.239, height=26, relwidth=0.1, bordermode='ignore')
        ...
        ToolTip(self.Entry_Localisation_X, self.tooltip_font, '''X position''')

        self.Entry_Localisation_Y = tk.Entry(self.rData)
        self.Entry_Localisation_Y.place(relx=0.284, rely=0.234, height=26, relwidth=0.1, bordermode='ignore')
        ...
        ToolTip(self.Entry_Localisation_Y, self.tooltip_font, '''y position''')

        self.Entry_Port = tk.Entry(self.rData)
        self.Entry_Port.place(relx=0.149, rely=0.313, height=26, relwidth=0.1, bordermode='ignore')
        ...
        ToolTip(self.Entry_Port, self.tooltip_font, '''Port''')

        self.Entry_UUID = tk.Entry(self.rData)
        self.Entry_UUID.place(relx=0.108, rely=0.389, height=26, relwidth=0.505, bordermode='ignore')
        ...
        ToolTip(self.Entry_UUID, self.tooltip_font, '''uuid or random''')

        self.Entry_Regionname = tk.Entry(self.rData)
        self.Entry_Regionname.place(relx=0.189, rely=0.468, height=26, relwidth=0.424, bordermode='ignore')
        ...
        ToolTip(self.Entry_Regionname, self.tooltip_font, '''Region Name''')
...
# Check Automatic region name.
        ...
        self.Checkbutton_Regionname.configure(text='''Automatic name''')
        self.Checkbutton_Regionname.configure(variable=automaticregion)
        self.tooltip_font = "TkDefaultFont"
        self.Checkbutton_Regionname_tooltip = \
        ToolTip(self.Checkbutton_Regionname, self.tooltip_font, '''Random Name''')

        self.Label_number_regions = tk.Label(self.rData)
        self.Label_number_regions.place(relx=0.027, rely=0.549, height=31, width=157, bordermode='ignore')
        ...
        self.Label_number_regions.configure(text='''Number of regions''')

        self.Entry_number_regions = tk.Entry(self.rData)
        self.Entry_number_regions.place(relx=0.257, rely=0.561, height=26, relwidth=0.073, bordermode='ignore')
        ...
        ToolTip(self.Entry_number_regions, self.tooltip_font, '''how many regions''')

# Create Region Button
        self.Button_Create = tk.Button(self.rData)
        self.Button_Create.place(relx=0.041, rely=0.788, height=42, width=65, bordermode='ignore')
        ...
        self.Button_Create.configure(text='''Create''')
        self.Button_Create.configure(command=write_region)
        self.tooltip_font = "TkDefaultFont"
        self.Button_Create_tooltip = \
        ToolTip(self.Button_Create, self.tooltip_font, '''Creates one or more regions depending on the setting.''')

# Exit Button
        self.Button_Exit = tk.Button(self.rData)
        self.Button_Exit.place(relx=0.162, rely=0.788, height=42, width=42, bordermode='ignore')
        ...
        ToolTip(self.Button_Exit, self.tooltip_font, '''Exit program.''')
...
# Check Automatic uuid.
        ...
        self.Checkbutton_Automatic_uuid.configure(text='''Automatic UUID''')
        self.Checkbutton_Automatic_uuid.configure(variable=automaticuuid)
        self.tooltip_font = "TkDefaultFont"
        self.Checkbutton_Automatic_uuid_tooltip = \
        ToolTip(self.Checkbutton_Automatic_uuid, self.tooltip_font, '''Random UUID''')
